...
def home():
	...
	return render_template("home.html", title='Home', infos=infos)
...
def struktur():
	...
	return render_template("struktur.html", title='Struktur Kepemimpinan dan Organisasi', gambars=gambars, gambar=gambar)

@app.route("/profiledesa")
def profiledesa():
	kadess = Kades.query.all()
	...
	return render_template("profiledesa.html", title='Profile Desa', kadess=kadess, admindesas=admindesas, umums=umums, penduduks=penduduks, saranapenunjangs=saranapenunjangs)

@app.route("/anggarandesa")
def anggarandesas():
	anggarandesas = AnggaranDesa.query.all()
	return render_template("anggarandesa.html", title='Anggaran Desa', anggarandesas=anggarandesas)
...
def bumdes():
	...
	return render_template("bumdes.html", title='BUMDES', pengurusbumdess=pengurusbumdess, adminbumdess=adminbumdess, unitusahas=unitusahas, keuangans=keuangans)
